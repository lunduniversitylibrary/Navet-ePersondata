...
my %CONFIG = (  
    ...
    soap_options => { proxy => 'https://ppx4.skatteverket.se/nawa15/na_epersondata/V2/personpostXML'}
);
...
throws_ok {
    $pkg->new( %CONFIG,
               format => 'xml',
               soap_options => {
proxy => 'https://ppx4.skatteverket.se/nawa15/na_epersondata/V2/personpost'
               },
             )
...
lives_ok {$client= $pkg->new( %CONFIG, format => 'termdata',
    soap_options => { proxy => 'https://ppx4.skatteverket.se/nawa15/na_epersondata/V2/personpost' },
